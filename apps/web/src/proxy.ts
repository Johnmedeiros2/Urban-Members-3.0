...
const PUBLIC_ROUTES = ["/", "/login", "/cadastro", "/onboarding", "/recuperar-senha", "/nova-senha", "/admin", "/feed", "/mercado", "/sala-de-aula", "/perfil", "/pagamento", "/api/mercadopago", "/compras", "/pulse", "/curso", "/lives", "/live", "/wishlist", "/agenda", "/trilhas", "/trilha", "/buscar", "/empresa", "/landing-v2", "/privacidade", "/termos"];
...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.ico|robots.txt|sitemap.xml|logo.svg|images/|.*\\.svg|.*\\.png|.*\\.jpg|.*\\.jpeg|.*\\.webp|.*\\.txt|.*\\.xml).*)"],
};
