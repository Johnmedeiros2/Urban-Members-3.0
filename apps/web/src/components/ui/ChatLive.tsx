      ...
      {meuId ? (
        <div style={{ borderTop: "1px solid #F5F5F5", padding: "10px 12px", display: "flex", gap: "8px" }}>
          <input
            ...
            maxLength={300}
            style={{ flex: 1, height: "38px", borderRadius: "10px", border: "1.5px solid #E5E5E5", padding: "0 12px", fontSize: "13px", outline: "none", fontFamily: "Inter, sans-serif", transition: "border-color 0.2s" }}
