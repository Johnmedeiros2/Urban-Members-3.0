...
const PUBLIC_ROUTES = ["/", "/login", "/cadastro", "/onboarding", "/admin", "/feed", "/mercado", "/sala-de-aula", "/perfil", "/pagamento", "/api/mercadopago", "/compras", "/pulse", "/curso", "/lives", "/live", "/wishlist"];
